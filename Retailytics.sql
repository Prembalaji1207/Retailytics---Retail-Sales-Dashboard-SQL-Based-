...
--9. top 5 customers based on the highest total sales 
SELECT 
    customer_id,
...
--10. number of unique customers who purchased items from each category.:
SELECT 
    category,    
...
--11. to create each shift and number of orders (Example Morning <12, Afternoon Between 12 & 17, Evening >17):
WITH hourly_sale
AS
(
SELECT *,
